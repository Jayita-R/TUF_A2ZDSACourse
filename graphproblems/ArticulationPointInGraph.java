...
public class ArticulationPointInGraph {
    ...
    private ArrayList<Integer> articulationPoints(int n, ArrayList<ArrayList<Integer>> adj) {
        int[] vis=new int[n];
        int[] tin=new int[n];
        int[] low=new int[n];
        int[] mark=new int[n];
    ...
    private int timer=1;
    private void dfs(int node, int par, int[] vis, int[] tin, int[] low, int[] mark, ArrayList<ArrayList<Integer>> adj) {
        vis[node]=1;
